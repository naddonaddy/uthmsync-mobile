...
class StaffRegistration extends StatefulWidget {
  const StaffRegistration({Key? key}) : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        DropdownButtonFormField<String>(
                          value:
                              faculty ?? 'Select PTj', // Set the initial value
                          items: <String>[
                            'Select PTj',
                            'Timbalan Naib Canselor (Akademik & Antarabangsa)',
                            'Timbalan Naib Canselor (Penyelidikan & Inovasi)',
                            'Timbalan Naib Canselor (Hal Elhwal Pelajar & Alumni)',
                            'Pejabat Canselori',
                            'Pusat Islam',
                            'Pejabat Persekitaran, Keselamatan dan Kesihatan Pekerja (OSHE)',
                            ...
                            'Institut Kejuruteraan Integrasi (IIE)',
                            'Institut Transformasi Sosial dan Pembangunan Wilayah (TRANSFORM)',
                            'Institut Ahli Sunnah Wal Jamaah (ISWAJ)',
                            'Insititut Harta Tanah Malaysia (MyREI)',
                            'Pejabat Hal Ehwal Pelajar (PHEP)',
                            'Pusat Pembangunan Pelajar (PBP)',
                            'Pusat Kemajuan Kerjaya dan Alumni (PKKA)',
                            'Pusat Perumahan Pelajar (PRP)',
                            'Pusat Kaunseling Universiti (PCU)',
                            'Pusat Sukan Universiti (PSU)',
                            'Pusat Kebudayaan Universiti (PBU)',
                          ].map((String value) {
